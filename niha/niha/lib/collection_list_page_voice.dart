...
class _CollectionListPageState extends State<CollectionListPage> {
  ...
  void _navigateToVoicePage(BuildContext context, String collectionName) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Voice(collectionName: collectionName),
      ),
    );
  }
                        ...
                        child: Card(
                          ...
                          child: GestureDetector(
                            ...
                            child: ListTile(
                              ...
                              onTap: () => _navigateToVoicePage(context, collectionName),
                            ),
                          ),
                        ),
                      );
